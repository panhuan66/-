...
<ul class="nav nav-pills">
  ...
  <li><a href="/web_kf/Document_show">预算管理</a></li>
  <li><a href="/web_kf/Base_info">基础信息维护</a></li>
  <li><a href="/web_kf/Project_show?flag=1">数据发布</a></li>
  <li class="active"><a href="/web_kf/Project_time">工期配置</a></li>
...
<div class="panel-heading center">金审工程工期选择</div>
<div class="panel-body">
<table class="table table-hover table-responsive table-striped">
	<tr class="success" >
	<td rowspan=2>金审工程工期</td>
	</tr>
	<tr>
	<td>金审一期<input type="radio" name="js"></td>
	<td>金审二期<input type="radio" name="js"></td>
	</tr>
