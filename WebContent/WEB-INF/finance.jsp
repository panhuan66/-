...
$(document).ready(function(){
	...
	$("#bt_abj2").click(function(){
		//alert($('input:radio[name="abj"]:checked').val());
		$("input[name='fc_oneortwo_cx2']").val($('input:radio[name="abj2"]:checked').val());
		//$("input[name='fc_pj_cx']").val($('input:radio[name="pj"]:checked').val());
	});
...
<ul class="nav nav-pills">
  ...
  <li class="active"><a href="/web_kf/Finance_show?flag=0">财务管理</a></li>
...
<%-- <table class="table table-hover table-responsive table-striped" class="pull-right">
<c:forEach items="${requestScope.fc_list_radio }" var="fc_radio">
<tr class="success">
</tr>
<tr>
<td><input type="radio" name="fc"  value="${fc_radio.finance_id}"></td>
</tr>
</c:forEach>
</table> --%>
<table class="table table-hover table-responsive table-striped" class="pull-right">
...
<br />
	...
	<div class="panel panel-primary">
	<div class="panel-heading center">财务信息维护</div>
	<div class="panel-body">
	...
	<table class="table table-hover table-responsive table-striped">
       ...
       <script type="text/javascript">
		...
		<tr>
		<td class="col-lg-2">借方科目</td>
		<td class="col-lg-4">			
			<div class="input-group">
		      <input type="text" class="form-control" name="fc_oneortwo_cx" id="ip_abj" >
		      <span class="input-group-btn">
		        <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal_abj">借方科目</button>
		      </span>
		    </div><!-- /input-group -->
		</td>
		<td class="col-lg-2">贷方科目</td>
		<td class="col-lg-4">			
			<div class="input-group">
		      <input type="text" class="form-control" name="fc_oneortwo_cx2" id="ip_abj2" >
		      <span class="input-group-btn">
		        <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal_abj2">贷方科目</button>
		      </span>
		    </div><!-- /input-group -->
		</td>
		</tr>
...
<!--  1，会计科目-->
<!-- Modal -->
<div class="modal fade" id="myModal_abj2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel_abj2" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel_abj2">会计科目</h4>
      </div>
      <div class="modal-body">
		       <table class="table table-hover table-responsive table-striped">
				...
				<tr>
				<td><input type="radio" name="abj2" value="${abj.accountant_subject_name}" id="ip_abj2"></td>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal" id="bt_abj2">选择</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
