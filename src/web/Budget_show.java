...
/**
 * Servlet implementation class Budget_show
 */
@WebServlet("/Budget_show")
public class Budget_show extends HttpServlet {
...
//			System.out.print(fg == 0 );
			if(fg == 0){
				request.getRequestDispatcher("/WEB-INF/budget.jsp").forward(request, response);
